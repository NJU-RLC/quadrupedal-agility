...
def update_cfg_from_args(env_cfg, cfg_train, args):
    ...
    if env_cfg is not None:
        ...
        if args.randomize_base_mass:
            env_cfg.domain_rand.randomize_base_mass = args.randomize_base_mass
        if args.randomize_base_com:
            env_cfg.domain_rand.randomize_base_com = args.randomize_base_com
        if args.push_robots:
            env_cfg.domain_rand.push_robots = args.push_robots
        if args.tracking_goal_vel is not None:
            env_cfg.rewards.scales.tracking_goal_vel = args.tracking_goal_vel
        if args.tracking_yaw is not None:
            env_cfg.rewards.scales.tracking_yaw = args.tracking_yaw
        if args.action_hl_rate is not None:
            env_cfg.rewards.scales.action_hl_rate = args.action_hl_rate
        if args.reach_goal is not None:
            env_cfg.rewards.scales.reach_goal = args.reach_goal
        if args.termination is not None:
            env_cfg.rewards.scales.termination = args.termination
        if args.target_lin_vel is not None:
            env_cfg.rewards.target_lin_vel = args.target_lin_vel
        if args.curr_threshold is not None:
            env_cfg.obstacle.curr_threshold = args.curr_threshold
        if args.randomize_start is not None:
            env_cfg.obstacle.randomize_start = args.randomize_start
        if args.curriculum is not None:
            env_cfg.obstacle.curriculum = args.curriculum
    if cfg_train is not None:
        ...
        if args.resume:
            cfg_train.estimator.load_estimator_bbc = False
...
def get_args():
    custom_parameters = [
        ...
        {"name": "--proj_name", "type": str, "default": "agility", "help": "run folder name."},
        ...
        {"name": "--tracking_goal_vel", "type": float},
        {"name": "--tracking_yaw", "type": float},
        {"name": "--action_hl_rate", "type": float},
        {"name": "--termination", "type": float},
        {"name": "--reach_goal", "type": float},
        {"name": "--reward_i_coef", "type": float},
        {"name": "--reward_t_coef", "type": float},
        {"name": "--curr_threshold", "type": float},
        {"name": "--target_lin_vel", "type": float},
        {"name": "--randomize_start", "action": "store_true", "default": False},
        {"name": "--curriculum", "action": "store_true", "default": False},
        {"name": "--randomize_base_mass", "action": "store_true", "default": False},
        {"name": "--randomize_base_com", "action": "store_true", "default": False},
